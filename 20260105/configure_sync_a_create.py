"""
Configure Census Sync A (CREATE) via API
...
def create_sync_a(config, conn_ids):
    ...
    sync_config = {
        ...
        "mappings": [
            # Core Identifiers
            {"from": {"type": "column", "data": "sfdc_id"}, "to": "sf_property_id__c", "is_primary_identifier": True},
...
def main():
    """Main function"""
    print("\n" + "="*80)
    print("CENSUS SYNC A (CREATE) - CONFIGURATION")
    print("="*80)
    ...
    try:
        ...
        print(f"2. Run configure_sync_b_update.py to create UPDATE sync")
